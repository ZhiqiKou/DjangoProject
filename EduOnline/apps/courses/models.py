...
class Course(models.Model):
    ...
    learn_times = models.IntegerField(default=0, verbose_name=u'学习时长(单位：min)')
    ...
    you_need_kown = models.CharField(default='', max_length=300, verbose_name=u'课程须知')
    ...
    def go_to(self):
        ...
        return mark_safe("<a herf='https://www.baidu.com'>跳转</a>")
